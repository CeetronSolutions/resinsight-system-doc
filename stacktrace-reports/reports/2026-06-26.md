---
title: Stacktrace report 2026-06-26
permalink: /stacktrace-reports/reports/2026-06-26/
layout: wide
---

# Stacktrace report 2026-06-26

- **Source CSV:** [2026-06-26-query_data.csv](../csv/2026-06-26-query_data.csv)
- **Total crash reports:** 230
- **Unique call stacks:** 81
- **Rows skipped (old version):** 11
...
**Notes:** Crash at RiaWellNameComparer.cpp:87 (formatter lambda -> inlined removeWellNamePrefix), a SIGSEGV inside the unsynchronized static std::map caches (sm_nameWithoutPrefix/sm_matchedName, added in 8daf25ffb3). Ruled out: (1) concurrency on the reported path - association loop (RimEclipseCase.cpp:1212) is sequential, plot scheduler is main-thread, and gRPC worker only enqueues (handlers run on main thread via processAllQueuedRequests), so no concurrent map access; (2) std::regex recursion stack overflow - inputs here are Eclipse sim well names (<=8 chars) and a well-path name, far too short; (3) null/dangling refs - proj deref'd earlier without crash, simulationWellNames() temporary lifetime-extended through the chain, eclData null-guarded. With short inputs and a single-threaded path, the fault in the map cache most likely makes this a victim frame of heap/state corruption originating elsewhere, or a rare concurrency not locatable in source. Uncertain because no reproduction and no single provable unsafe operation at this site; low frequency (3 hits, single version 2026.02.2).
...
**Notes:** Crash at cvfBoundingBoxTree.cpp:844, m_leafPool.resize() in BoundingBoxTreeImpl::createLeaves during RigMainGrid::buildCellSearchTree on case import. SIGSEGV in the trivial Vec3d default ctor while value-constructing leaves = memory commit failure (OOM) allocating one AABBTreeNodeLeaf per active cell on a very large grid. Ruled out null/OOB/UAF/overflow and the #14182 deep-tree stack overflow. No confident fix: OOM is not guardable, std::bad_alloc catch won't catch an overcommit SIGSEGV, and reducing per-leaf memory is a non-minimal refactor that only raises the ceiling. Single occurrence (2026-06-02), no recurrence.
...
First seen: `2026-05-28T07:05:11.473Z`  
Last seen: `2026-06-24T13:12:54.744Z`  
Versions: `2026.02.2` (60), `2026.06.0` (20)
...
First seen: `2026-05-31T19:17:29.126Z`  
Last seen: `2026-06-11T06:21:46.27Z`  
Versions: `2026.02.2` (7), `2026.06.0-RC_1` (1)
...
First seen: `2026-05-29T09:28:52.74Z`  
...
First seen: `2026-05-31T07:42:21.605Z`  
Last seen: `2026-06-11T12:25:22.03Z`  
Versions: `2026.02.2` (5), `2026.02.3-dev.01` (1)
...
Last seen: `2026-06-24T13:37:07.044Z`  
Versions: `2026.06.0` (2)
...
Last seen: `2026-06-24T07:53:10.035Z`  
Versions: `2026.06.0` (1), `2026.06.1-dev.02` (1)
...
Last seen: `2026-06-20T23:50:34.731Z`  
Versions: `2026.06.0` (2)
...
**OPM issue:** [#14386](https://github.com/OPM/ResInsight/issues/14386) — CLOSED

**Notes:** ESmry::getListOfArrays (opm-common submodule) missing fopen NULL check -> segfault on locked/deleted UNSMRY. Fix in CeetronSolutions/opm-common#13 (branch fix-esmry-getlistofarrays-fopen, targets development-01); ResInsight PR 14390 bumps the submodule and depends on that merge.
...
Last seen: `2026-06-23T19:14:28.839Z`  
Versions: `2026.06.0` (1)
...
First seen: `2026-06-02T07:05:17.144Z`  
...
Last seen: `2026-06-25T07:21:46.548Z`  
